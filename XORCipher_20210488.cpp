...
//Program Name: XORCipher_20210488.cpp
//Program Description: This program is used to encrypt and decrypt text by XORing it with a secret key
// The secret key here is "P"
// User can decipher text from hexaDecimal input also
//
//Last Modification Date: March 13, 2022
//Version: v1.1.4
